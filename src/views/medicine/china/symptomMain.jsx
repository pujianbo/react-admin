    ...
    this.columns = [
      {
        ...
        title: '所属性别',
        render: (value, record) => ['女', '男', '儿童'][record.crowd]
      }, {
        title: '创建时间',
    ...
    return (<div>
      ...
      <Form layout="inline" className='frminput' id='lbl5'>
        <Row gutter={8}>
          <Col span={8}>
            <FormItem label="主症状">
              <Input placeholder='搜索主症状' onChange={this.getValue.bind(this, 'name')} style={{width: '220px'}}/>
            </FormItem>
          </Col>
          <Col span={8}>
            <FormItem label="性别">
              <Select defaultValue="-1" onChange={this.sltStatus.bind(this, 'crowd')} style={{width: '220px'}}>
          ...
          <Col span={8}>
            <FormItem label="部位">
              <Select placeholder='先选择性别' style={{
                  width: 220
