    ...
    this.columns = [
      {
        ...
        title: '药品类别',
        render: (value, record) => this.fntype == 1
          ? '中成药'
          : '中药方'
      }, {
        title: '创建时间',
        ...
        key: 'id',
        render: (value, record) => {
          return <Link title='详情' to={`/medicine/china/detail/${record.id || record.code}/${this.fntype == 1
              ? 3
              : 7}`}><Icon type="exclamation-circle-o"/></Link>
        }
      }
    ];
  }
